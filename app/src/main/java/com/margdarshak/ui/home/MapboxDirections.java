...
public abstract class MapboxDirections extends
        MapboxService<DirectionsResponse, CustomDirectionService> {

    protected MapboxDirections() {
        super(CustomDirectionService.class);
    }
     ...
     *
     * @return a {@link MapboxDirections.Builder} object for creating this object
     * @since 3.0.0
     */
    ...
    public abstract static class Builder {
         ...
         * @since 1.0.0
         */
        public abstract MapboxDirections.Builder user(@NonNull String user);
         ...
         * @since 1.0.0
         */
        public abstract MapboxDirections.Builder profile(@NonNull @ProfileCriteria String profile);
         ...
         * @since 1.0.0
         */
        public MapboxDirections.Builder origin(@NonNull Point origin) {
            this.origin = origin;
            return this;
        }
         ...
         * @since 1.0.0
         */
        public MapboxDirections.Builder destination(@NonNull Point destination) {
         ...
         * @since 3.0.0
         */
        public MapboxDirections.Builder addWaypoint(@NonNull Point waypoint) {
         ...
         * @since 1.0.0
         */
        public abstract MapboxDirections.Builder alternatives(@Nullable Boolean alternatives);
         ...
         * @since 2.0.0
         */
        public abstract MapboxDirections.Builder geometries(@GeometriesCriteria String geometries);
         ...
         * @since 1.0.0
         */
        public abstract MapboxDirections.Builder overview(@Nullable @OverviewCriteria String overview);
         ...
         * @since 1.0.0
         */
        public abstract MapboxDirections.Builder steps(@Nullable Boolean steps);
         ...
         * @since 1.0.0
         */
        public abstract MapboxDirections.Builder continueStraight(@Nullable Boolean continueStraight);
         ...
         * @since 2.2.0
         */
        public MapboxDirections.Builder language(@Nullable Locale language) {
            if (language != null) {
        ...
        abstract MapboxDirections.Builder language(@Nullable String language);
         ...
         * @since 3.0.0
         */
        public abstract MapboxDirections.Builder roundaboutExits(@Nullable Boolean roundaboutExits);
         ...
         * @since 2.1.0
         */
        public MapboxDirections.Builder annotations(@Nullable @AnnotationCriteria String... annotations) {
         ...
         * @since 2.0.0
         */
        public MapboxDirections.Builder addBearing(@Nullable @FloatRange(from = 0, to = 360) Double angle,
        ...
        abstract MapboxDirections.Builder bearing(@Nullable String bearings);
         ...
         * @since 1.0.0
         */
        public MapboxDirections.Builder radiuses(@FloatRange(from = 0) double... radiuses) {
            this.radiuses = radiuses;
            return this;
        }

        abstract MapboxDirections.Builder radius(@Nullable String radiuses);
         ...
         * @since 3.0.0
         */
        public abstract MapboxDirections.Builder exclude(@ExcludeCriteria String exclude);
         ...
         * @since 3.0.0
         */
        public abstract MapboxDirections.Builder voiceInstructions(@Nullable Boolean voiceInstructions);
         ...
         * @since 3.0.0
         */
        public abstract MapboxDirections.Builder bannerInstructions(@Nullable Boolean bannerInstructions);
         ...
         * @since 3.0.0
         */
        public abstract MapboxDirections.Builder voiceUnits(@Nullable @VoiceUnitCriteria String voiceUnits);
         ...
         * @since 2.1.0
         */
        public abstract MapboxDirections.Builder baseUrl(String baseUrl);
         ...
         * @return this builder for chaining options together
         */
        public abstract MapboxDirections.Builder interceptor(Interceptor interceptor);
         ...
         * @return this builder for chaining options together
         */
        public abstract MapboxDirections.Builder eventListener(EventListener eventListener);

        abstract MapboxDirections.Builder coordinates(@NonNull List<Point> coordinates);
         ...
         * @since 3.2.0
         */
        public MapboxDirections.Builder addApproaches(String... approaches) {
            this.approaches = approaches;
            return this;
        }

        abstract MapboxDirections.Builder approaches(@Nullable String approaches);
         ...
         * @since 4.4.0
         */
        public MapboxDirections.Builder addWaypointIndices(@Nullable @IntRange(from = 0) Integer... waypointIndices) {
            this.waypointIndices = waypointIndices;
            return this;
        }

        abstract MapboxDirections.Builder waypointIndices(@Nullable String waypointIndices);
         ...
         * @since 3.3.0
         */
        public MapboxDirections.Builder addWaypointNames(@Nullable String... waypointNames) {
            this.waypointNames = waypointNames;
            return this;
        }

        abstract MapboxDirections.Builder waypointNames(@Nullable String waypointNames);
         ...
         * @since 4.3.0
         */
        public MapboxDirections.Builder addWaypointTargets(@Nullable Point... waypointTargets) {
            this.waypointTargets = waypointTargets;
            return this;
        }

        abstract MapboxDirections.Builder waypointTargets(@Nullable String waypointTargets);
         ...
         * @since 4.4.0
         */
        public abstract MapboxDirections.Builder enableRefresh(Boolean enableRefresh);
         ...
         * @since 4.6.0
         */
        public MapboxDirections.Builder post() {
            usePostMethod(true);
            return this;
        }
         ...
         * @since 4.6.0
         */
        public MapboxDirections.Builder get() {
            usePostMethod(false);
            return this;
        }
         ...
         * @since 4.8.0
         */
        public abstract MapboxDirections.Builder walkingOptions(@NonNull WalkingOptions walkingOptions);

        abstract WalkingOptions walkingOptions();

        abstract MapboxDirections.Builder usePostMethod(@NonNull Boolean usePost);
        ...
        /**
         * This uses the provided parameters set using the {@link MapboxDirections.Builder} and first checks that all
